 ...
 *  		SoketInputStream / SoketOutputStream
 ...
 *  		ObjectInput[Output]Stream : Serializable 객체 직렬화/역지렬화 스트림.
 * 
 */
public class StreamDesc {
	...
	public static void  readAndPrintClassPathResource() throws URISyntaxException, IOException{
		//String resCpPath = "/kr/or/ddit/medias/오래된 노래_utf8.txt";
		String resCpPath = "/kr/or/ddit/medias/오래된 노래.txt";
		String filePath = "D:\\contents\\오래된 노래.txt";
		try(
			// step2
